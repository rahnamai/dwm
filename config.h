...
static const char *musicplayercmd[]  = { "spotify", "--force-device-scale-factor=1.5", NULL };
...
/* Volume */
static const char *incvol[]  = { "amixer", "set", "Master", "10%+", NULL };
static const char *decvol[]  = { "amixer", "set", "Master", "10%-", NULL };
